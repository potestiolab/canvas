...
python3 $PYTHONDIR/CANVAS-MPI4.py -g $inputDIR/frame_4ake_125ns.gro -l list-atoms-opt-2.txt -t $inputDIR/topol.top -d $inputDIR/dom.txt -s n

rm -rf test-kinase-amber99-gromacs-NoSolv
mkdir test-kinase-amber99-gromacs-NoSolv

mv run_simulation/ other-files/ analysis/ test-kinase-amber99-gromacs-NoSolv
