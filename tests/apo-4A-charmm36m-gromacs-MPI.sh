...
echo $CHARMM_PATH | python3 $PYTHONDIR/CANVAS-MPI4.py -g $inputDIR/apo-4A.gro -l list-atoms-opt-2.txt -t $inputDIR/topol.top -d $inputDIR/dom.txt

rm -rf test-apo-4A-charmm36m-gromacs 
mkdir test-apo-4A-charmm36m-gromacs

mv run_simulation/ other-files/ analysis/ test-apo-4A-charmm36m-gromacs 
