...
if(option == "choice1"):
    ...
    def update_6p7_AT(list_AT_residues, j):
        for i in list_AT_residues:
            if(j[0]==i):
                return j[3] 
    
    def update_6p7_BB(list_bb_residues, j):
        for i in list_bb_residues:
            if((j[0]==i) and (j[2]=="CA" or j[2]=="O" or j[2]=="N" or j[2]=="C" or j[2]=="OC1")):
                return j[3]
    
    def update_6p7_CG(list_CG_residues, j):
    ...
    temp       = partial(update_6p7_BB, list_bb_residues)
    upd_6p7_BB = pool.map(temp, iterable=atoms)
    
    temp       = partial(update_6p7_CG, list_CG_residues)
...
#7. Choice2 selected...  
    ...
    def update_7p4(list_other_atoms, j): 
    ...
    def update_7p7_AT(list_AT_residues, j):
        for i in list_AT_residues:
            if(j[0]==i):
                return j[3]

    def update_7p7_BB(list_bb_residues, j):
        for i in list_bb_residues:
            if((j[0]==i) and (j[2]=="CA" or j[2]=="O" or j[2]=="N" or j[2]=="C" or j[2]=="OC1")):
                return j[3]

    def update_7p7_CG(list_CG_residues, j):
        for i in list_CG_residues:
            if((j[0]==i) and (j[2] == "CA")):
                return j[3]
    ...
    temp       = partial(update_7p7_BB, list_bb_residues)
    upd_7p7_BB = pool.map(temp, iterable=atoms)

    temp       = partial(update_7p7_CG, list_CG_residues)
...
# 8. Choice3 selected...
    ...
    def update_8p4_AT(list_AT_residues, j):
        for i in list_AT_residues:
            if(j[0]==i):
                return j[3]

    def update_8p4_BB(list_bb_residues, j):
        for i in list_bb_residues:
            if((j[0]==i) and (j[2]=="CA" or j[2]=="O" or j[2]=="N" or j[2]=="C" or j[2]=="OC1")):
                return j[3]

    def update_8p4_CG(list_CG_residues, j):
        for i in list_CG_residues:
            if((j[0]==i) and (j[2] == "CA")):
                return j[3]
    ...
    temp       = partial(update_8p4_BB, list_bb_residues)
    upd_8p4_BB = pool.map(temp, iterable=atoms)

    temp       = partial(update_8p4_CG, list_CG_residues)
