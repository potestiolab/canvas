...
## 14.1- For each survived atom and other ones (decimated atoms) create a inner list containing the value of reference block and relative x,y,z values 
...
## A.2.1- Writing the at_type and at/cg for each atom involved in the bonds
...
def update_s14_eps14(pairttypes, i):
    for j in pairtypes:
        if((j[0]==i[2] and j[1]==i[3]) or (j[0]==i[3] and j[1]==i[2])):
            i.append(float(j[2]))
            i.append(float(j[3]))
